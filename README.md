...
6. `backend/` exposes the evaluation API and `frontend/` hosts the resume dashboard.
...
- `backend/`
  FastAPI backend layer and persistence.

- `frontend/`
  React + TypeScript dashboard for file upload, evaluation, and history.
